...
for ($x = 0; $x < count($rowarray); $x++) {
	...
	foreach ( $rowarray[$x] as $review ) 
	{
		...
		if($review->type=="TripAdvisor"){
			...
			$logo = '<a href="'.$burl.'" target="_blank" rel="nofollow"><img src="'.$imgs_url.'tripadvisor_outline.png" alt="" class="wptripadvisor_t1_tripadvisor_logo"></a>';
			...
			$logo = '<a href="'.$burl.'" target="_blank" rel="nofollow"><img src="'.$imgs_url.'fb_logo.png" alt="" class="wptripadvisor_t1_tripadvisor_logo"></a>';
		}  else  {
			$starfile = "stars_".$review->rating."_yellow.png";
			$logo ="";
		}
