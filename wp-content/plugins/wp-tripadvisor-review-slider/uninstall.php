...
if ( ! defined( 'WP_UNINSTALL_PLUGIN' ) ) {
	exit;
		...
		// Leave no trail wp-tripadvisor-review-slider_version widget_wptripadvisor_widget
		$option1 = 'wp-tripadvisor-review-slider_version';
		$option2 = 'wptripadvisor_tripadvisor_settings';
		$option3 = 'widget_wptripadvisor_widget';
		$option4 = 'wptripadvisor_options';
