		...
		<table class="wp-list-table widefat striped posts">
			<thead>
				<tr>
					...
					<th scope="col" width="100px" class="manage-column"><a href="'.esc_url( add_query_arg( 'sortby', 'pagename',$currenturl ) ).$sortdirection.'"><i class="dashicons dashicons-sort '.$sorticoncolor[5].'" aria-hidden="true"></i> '.__('Page Name', 'wp-tripadvisor-reviews').'</a></th>
